...
class User(models.Model):
    username = models.CharField(null = False, blank = False, unique = True, validators = [
...
class Tag(models.Model):
    ...
    tag = models.CharField(null = False, blank = False, validators = [
...
class Task(models.Model):
    task = models.CharField(null = False, blank = False, validators= [
